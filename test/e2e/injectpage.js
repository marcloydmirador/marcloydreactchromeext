...
describe('inject page (in github.com)', function test() {
  ...
  it('should render inject app', async () => {
    await driver.wait(
      () => driver.findElements(webdriver.By.className('inject-react-'))
  ...
  it('should find `Open TodoApp` button', async () => {
    await driver.wait(
      () => driver.findElements(webdriver.By.css('.inject-react- button'))
        .then(elems => elems.length > 0),
      10000,
  ...
  it('should find iframe', async () => {
    driver.findElement(webdriver.By.css('.inject-react- button')).click();
    await delay(1000);
    await driver.wait(
      () => driver.findElements(webdriver.By.css('.inject-react- iframe'))
        .then(elems => elems.length > 0),
      10000,
